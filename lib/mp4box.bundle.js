var MP4BoxBundle = (() => {
  ...
  // mp4box_entry.js
  var mp4box_entry_exports = {};
  __export(mp4box_entry_exports, {
  ...
  // mp4box_entry.js
  if (typeof window !== "undefined") window.MP4Box = mp4box_all_exports;
  if (typeof globalThis !== "undefined") globalThis.MP4Box = mp4box_all_exports;
  return __toCommonJS(mp4box_entry_exports);
})();
